...
function newpost()
{
	...
	for(var i=0;i<10;i++)
	{
		...
		var text3=document.createTextNode("Standing in solidarity with Palestine, advocating for justice, human rights, and peace. Together, we strive for freedom and dignity. #FreePalestine");
...
function mypost()
{
	...
	var para=document.createElement("p");
	para.className="name";
	var text1=document.createTextNode("Mohamedamine Satou");
	para.appendChild(text1);
	div2.appendChild(para);
	div.appendChild(div2);
